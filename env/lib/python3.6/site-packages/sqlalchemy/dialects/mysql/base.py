...
.. seealso::
    ...
    `CREATE INDEX <http://dev.mysql.com/doc/refman/5.0/en/create-master_layout.html>`_ - MySQL documentation
...
http://dev.mysql.com/doc/refman/5.0/en/create-master_layout.html
